...
<template>
  <div id="authGate">
    <div class="authbox">
      ...
      <p style="text-align:center;color:rgba(255,255,255,.95);font-size:12px;margin-bottom:6px">Sign in to continue</p>
      ...
      <p style="margin-top:14px;font-size:11px;color:rgba(255,255,255,.92);text-align:center;line-height:1.5">
