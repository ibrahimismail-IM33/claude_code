...
<template>
  <!-- eslint-disable-next-line vue/no-v-html -- SVG generated by our own lib/donut.js builder from numeric data; no user input -->
  <div class="donutwrap" id="dashDonut" @click="onClick" @mouseover="onOver" @mouseleave="onLeave" @keydown="onKey" v-html="svg"></div>
</template>
